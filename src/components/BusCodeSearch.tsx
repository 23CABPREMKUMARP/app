        ...
        <div className="p-6 md:p-8">
          ...
          <form onSubmit={handleSearch} className="relative group">
            ...
            <input
              ...
              className="w-full bg-zinc-50 border-2 border-zinc-100 rounded-2xl py-5 pl-14 pr-32 text-sm md:text-base font-bold tracking-widest text-zinc-950 placeholder:text-zinc-300 outline-none focus:border-zinc-950 focus:ring-4 focus:ring-zinc-950/5 transition-all uppercase"
            />
